...
<div class="<?php echo esc_attr(implode(' ', $neuron_media_hover_class)) ?>">
    ...
    <?php if ($media['query_title'] || $media['query_subtitle'] || $media['query_type'] == 'video') : ?>
        <div class="o-neuron-hover__body">
            <div class="o-neuron-hover__body-meta">
                ...
                <?php endif; ?>
                <?php if ($media['query_title']) : ?>
                    <div class="o-neuron-hover__body-meta__subtitle m-media-gallery__item--subtitle"><?php echo esc_attr($media['query_subtitle']) ?></div>
                <?php endif; ?>
                <?php if ($media['query_description']) : ?>
                    <p class="o-neuron-hover__body-meta__description m-media-gallery__item-description"><?php echo wp_kses_post($media['query_description']) ?></p>
                <?php endif; ?>
            </div>
        </div>
    <?php endif; ?>       
