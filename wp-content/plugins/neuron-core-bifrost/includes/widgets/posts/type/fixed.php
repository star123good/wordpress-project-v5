 ...
 * Meta Fixed
 */
$neuron_fixed_meta_inside_class = 'o-neuron-hover';
...
if ($settings['posts_hover_visibility'] == 'show') {
    $neuron_fixed_meta_inside_class .= ' o-neuron-hover--meta-inside';
}
...
if ($settings['posts_hover_animation']) {
    $neuron_fixed_meta_inside_class .= ' o-neuron-hover--'. $settings['posts_hover_animation'] .'';
}
...
?>
<div class="<?php echo esc_attr($neuron_fixed_meta_inside_class) ?>">
