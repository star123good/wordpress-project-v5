...
class NeuronHamburger extends Widget_Base {
	...
	?>
		<div class="a-hamburger-holder d-flex justify-content-center" id="<?php echo esc_attr($this->get_ID()) ?>">
			<a href="#" class="a-hamburger d-inline-flex" id="fixed-section-hamburger-<?php echo esc_attr($this->get_ID()) ?>">
				<svg style="enable-background:new 0 0 139 139;" width="42px" height="42px" version="1.1" viewBox="0 0 139 139" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><line class="st0" x1="26.5" x2="112.5" y1="46.3" y2="46.3"/><line class="st0" id="XMLID_9_" x1="26.5" x2="112.5" y1="92.7" y2="92.7"/><line class="st0" id="XMLID_8_" x1="26.5" x2="112.5" y1="69.5" y2="69.5"/></svg>
			</a>
		</div>
		<script>
			jQuery(document).ready(function($) {
				$('.a-hamburger-holder#<?php echo esc_attr($this->get_ID()) ?> #fixed-section-hamburger-<?php echo esc_attr($this->get_ID()) ?>').on('click', function(e) {
					e.preventDefault();
					e.stopPropagation();
