...
Kirki::add_field('neuron_kirki', array(
	'type'        => 'custom',
	'settings'    => 'portfolio_item_related_title',
	'section'     => 'portfolio_item_options',
...
Kirki::add_field('neuron_kirki', array(
	'type'        => 'select',
	'settings'    => 'portfolio_item_related',
...
Kirki::add_field('neuron_kirki', array(
	'type'        => 'select',
	'settings'    => 'portfolio_item_related_template',
    ...
    'active_callback' => array(
        array(
            'setting'  => 'portfolio_item_related',
            'operator' => '==',
            'value'    => '1'
        ),
    )
