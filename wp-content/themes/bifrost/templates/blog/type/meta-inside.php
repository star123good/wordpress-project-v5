 ...
 * Meta Inside
 */
$bifrost_blog_meta_inside_class = 'o-neuron-hover';
...
if ($neuron_posts_hover_visibility == 'show') {
    $bifrost_blog_meta_inside_class .= ' o-neuron-hover--meta-inside';
}
...
if ($neuron_posts_hover_visibility != 'hide' && $neuron_posts_hover_animation) {
    $bifrost_blog_meta_inside_class .= ' o-neuron-hover--' . $neuron_posts_hover_animation;
}
/**
 * Hover Active
 */
...
?>
<div class="<?php echo esc_attr($bifrost_blog_meta_inside_class) ?>">
